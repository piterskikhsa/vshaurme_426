...
from vshaurme.emails import send_change_email_email
from vshaurme.extensions import db, avatars
from vshaurme.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
...
def delete_account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(_('Your are free, goodbye!'), 'success')
